-- Idempotent invite accept + clearer error when QR already used by someone else.
...
begin
  ...
  -- Idempotent: same user scanning an already-accepted invite succeeds.
  if v_invite.accepted_at is not null then
    if v_invite.accepted_by_user_id is distinct from p_user_id then
