-- Prefer the newest organization membership when resolving the active dashboard org.
-- Previously oldest-first forced multi-org users onto legacy pilot orgs (e.g. "NEX Biz").
