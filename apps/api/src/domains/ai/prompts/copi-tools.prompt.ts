...
- \`pending_ai_drafts\`: \`{ count, drafts: [{ id, customerName, bodyPreview, draftType, createdAt }] }\` — when the owner asks to list/show drafts, summarize each item; do not only repeat the count.
