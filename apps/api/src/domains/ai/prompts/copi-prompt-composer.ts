  ...
  const layerHint =
    layer === 'router'
      ...
      : [
          ...
          'Answer in Argentine Spanish, natural and concise — like a sharp teammate, not a report.',
          'Use ONLY facts from toolResults / history. Never invent numbers.',
          'If alreadyGreetedInSession is true OR history already has an assistant greeting, do NOT start with ¡Hola / Buen día / etc. Jump straight to the answer.',
          ...
          'For sales questions (ganancia/ventas), speak casually: e.g. “Esta semana van 2 ventas, unos $11.900.” Avoid stiff templates like “has realizado … con un total aproximado”.',
